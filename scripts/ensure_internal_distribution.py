#!/usr/bin/env python3
"""Ensure internal Firebase builds are actually visible to testers."""
...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Ensure internal Firebase visibility before signoff.")
    parser.add_argument("--platform", choices=["firebase"], default="firebase")
